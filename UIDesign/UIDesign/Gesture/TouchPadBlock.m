...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (isLongPress)
    {
        if (currentType == Long_Press_Will_Cancle)
        {
            if (self.gestureType)
            {
                self.gestureType(Long_Press_Cancle);
            }
        }
        else
        {
            if (self.gestureType)
            {
                self.gestureType(Long_Press_End);
            }
        }
    }
}
    ...
    if (isLongPress)
    {
        if (longPressHeight>endPoi.y)
        {
            if (currentType != Long_Press_Will_Cancle)
            {
                ...
                if (self.gestureType)
                {
                    self.gestureType(Long_Press_Will_Cancle);
                }
            }
        }
        else
        {
            if (currentType != Long_Press_Continue)
            {
                ...
                if (self.gestureType)
                {
                    self.gestureType(Long_Press_Continue);
                }
            }
        }
    }
